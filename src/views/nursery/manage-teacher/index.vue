<template>
  <div class="container">
    ...
    <el-row class="el-row-add">
      <el-col :span="2" :offset="21"> <el-button size="small" style="width: 140px;" @click="showAddDialog">+添加教师</el-button></el-col>
    </el-row>
    <add-teacher ref="AddTeacherComponents" />
    <delete ref="DeleteComponents" title="是否删除该机构的信息" />
    <!--    表格-->
    <template class="table">
      <el-table :data="tableData" border style="width: 95%" max-height="320px">
        ...
        <el-table-column prop="lengthOfServiceSeniority" label="工龄" width="150" />
        ...
        <el-table-column prop="class" label="所带班级" width="300" />
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [{
        ...
        teacherName: '朱振强',
        title: '教授',
        lengthOfServiceSeniority: 30,
        class: '3班',
        phoneNumber: '17853593228',
        account: '5686646464',
        parentName: '朱振强',
        age: 18,
        sex: '男',
        address: '山东省临沂市费县城北乡荣和村',
        contact: '13791556326',
        remark: '无',
  ...
  methods: {
    ...
    showEditDialog(row) {
      this.$refs.AddTeacherComponents.showEditTeacherDialog(row)
    },
    showDeleteDialog(row) {
      this.$refs.DeleteComponents.showDeleteDialog(row)
    },
    // 分页操作
